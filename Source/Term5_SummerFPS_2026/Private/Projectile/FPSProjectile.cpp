...
AFPSProjectile::AFPSProjectile()
{
	...
	// ///Game/Assets/3D_Models/Sphere/Sphere.Sphere
	// Game / Assets / Materials / M_Projectile.M_Projectile
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ProjectileMeshAsset(TEXT("/Game/Assets/3D_Models/Sphere/Sphere.Sphere"));
	...
	// 3. Get Material Asset
	static ConstructorHelpers::FObjectFinder<UMaterial> ProjectileMaterialAsset(TEXT("/Game/Assets/Materials/M_Projectile.M_Projectile"));
...
void AFPSProjectile::OnWhateverWeWantToNameThis(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (Enemy)
	{
		Enemy->OnEnemyTakeDamage(20.0f); // damage value
		Destroy();
		return;
	}
